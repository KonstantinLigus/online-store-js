      ...
      <div className={styles.article}>
        ...
        <div className={styles.articleContainer}>
          ...
          <p>
            ...
            Урбана-Шампейн. &#34;Навіть пасічники та дослідники бджіл вважали
            його нічим іншим як цукровою водою&#34;.
          </p>
          ...
          <p>
            ...
            твердий пилок. &#34;Віск - дуже гнучкий будівельний матеріал&#34;, -
            каже Крістіна Грозінгер, ентомолог з Університету штату
            Пенсильванія, яка вивчає соціальну поведінку й здоров&apos;я бджіл.
            Утворюючи стільники, медоносні бджоли формують з воску шестикутники.
            Це - найефективніша форма для зберігання будь-чого, тому що
            шестикутники щільно укладаються поруч. &#34;Це геніальне інженерне
            рішення&#34;, - каже Грозінгер. Побудова численних невеликих
            однорідних клітин має ще одну перевагу. Більша площа поверхні
            означає, що вода швидше випаровується, і отже, містить менше
            мікробів. Процес виробляння меду, який заповнить чарунки стільника,
            починається, коли бджола ковтає нектар. Насправді вона його не їсть,
            принаймні солодка закуска не потрапляє до шлунку у традиційному
            розумінні. Вона зберігає нектар у своєму медовому шлунку, де він
            змішується з різними ферментами
          </p>
